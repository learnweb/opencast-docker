...
[![Build Status](https://github.com/opencast/opencast-docker/workflows/main/badge.svg?branch=master)](https://github.com/opencast/opencast-docker/actions) [![Docker Repository on Quay](https://quay.io/repository/opencast/allinone/status "Docker Repository on Quay")](https://quay.io/repository/opencast/allinone)
...
Opencast comes in different distributions. For each of the official distributions, there is a specific Docker image. Each version is tagged. For example, the full image name containing the `admin` distribution at version `10.0` is `quay.io/opencast/admin:10.0`. Leaving the version out will install the latest one.
